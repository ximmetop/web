...
<head>
  <title>twenty one pilots</title>
  <meta name="twenty one pilots" content="encabezado">
  ...
  <style>
    ...
    .social-icons, .music-platforms {
      display: flex;
      justify-content: center;
      margin-top: 20px;
    }
    .social-icons a, .music-platforms a {
      margin: 0 10px;
    ...
    .social-icons i:hover, .music-platforms i:hover {
      transform: scale(1.2);
    }
    .social-icons a:visited, .music-platforms a:visited {
      color: inherit;
    }
    .fa-instagram {
      color: #C32AA3;
...
<body>
  <center>
    <h1 style="font-size: 60px; color: yellow;">twenty one pilots</h1>
    <table border="1" width="1300" height="1000">
      <tr>
